...
- [ ] Register routes in `web.php` within the auth middleware.
- [ ] UI: Add the fish (🐟) button to the photo overview and the detail page.
- [ ] UI: Implement the comment section on the photo detail page (including reply form).
- [ ] UI: Add comment likes.
